...
from typing import (
    List, Tuple, Set, Iterable, Dict, Type, Any, Optional, Union
)
...
class FeatureToken(PersistableContainer, TextContainer):
    ...
    **Feature note**: features ``i`` and ``i_sent`` are always added to
    ...
    spacy_token: Union[Token, Span] = field(
    ...
    def _from_dictable(self, recurse: bool, readable: bool,
        ...
        for k, v in self.__dict__.items():
            if k != 'spacy_token' and not k.startswith('_'):
    ...
    def __eq__(self, other) -> bool:
        return self.i == other.i and self.asdict() == other.asdict()
